...
function drawScreen() {
	...
	drawCheckbox(keys.weapone, $body);
	// !WEAPONES create
...
function drawNumber(keyArr, $body){
...
function drawCheckbox(keyArr, $body){
